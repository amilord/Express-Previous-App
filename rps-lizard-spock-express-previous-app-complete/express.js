// codeed with House Gardner: Dashlin, Brian, Julie, Ziya, Wade, Asianna, Tanecia
...
//looking in the main directory
app.set(`views`, __dirname)

// GET request (browser load) for `/`, we send the file `index.html`
...
// our server is listening for requests, on port 3000 put localhost:3000 in your browser
app.listen(3000, () => {
